...
public class ChatClient extends JFrame {
    ...
    public ChatClient() {
        ...
        getContentPane().setBackground(new Color(43, 47, 58));

        chatArea = new JTextArea();
        chatArea.setEditable(false);
        chatArea.setBackground(new Color(33, 37, 43));
        ...
        new Thread(this::setupClient).start();
    }
